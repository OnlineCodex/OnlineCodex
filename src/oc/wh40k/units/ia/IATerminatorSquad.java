...
public class IATerminatorSquad extends Eintrag {
    ...
    public IATerminatorSquad() {
        ...
        rkBoss = new RuestkammerStarter(ID, randAbstand, cnt, "IAJusticar", "Upgrade zum Justicar");
        rkBoss.initKammer();
		...
		rkRaider = new RuestkammerStarter(ID, randAbstand, cnt, "IALandRaiderKammer", "Land Raider");
		rkRaider.initKammer();
