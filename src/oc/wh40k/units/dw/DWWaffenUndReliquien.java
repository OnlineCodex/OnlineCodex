...
public class DWWaffenUndReliquien extends RuestkammerVater {
	...
	public void refreshen() {
		...
		if(type.equals("Chaplain"))
		{			
			if(handwaffe.isSelected() && o2.isSelected()) { substractor = 2; }
			else if(handwaffe.isSelected() || o2.isSelected()) { substractor = 1; }
			else if(!handwaffe.isSelected() && !o2.isSelected()) { substractor = 0; }
