...
public class DKABPlatoonCommandSquad extends RuestkammerVater {
	...
	public DKABPlatoonCommandSquad() {
		grundkosten = 50;
	}
  ...
  @Override
	public void initButtons(boolean... defaults) {
		...
		add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Carapace armour", 3));
		...
		add(com1 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Carapace armour", 3));
		add(com2 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "melta-bombs", 5));
