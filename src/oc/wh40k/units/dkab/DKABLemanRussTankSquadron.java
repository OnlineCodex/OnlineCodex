...
public class DKABLemanRussTankSquadron extends Eintrag {
	...
	public DKABLemanRussTankSquadron() {
		...
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "DKABLemanRuss", "", 1);
		t2.initKammer();
		...
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "DKABLemanRuss", "", 1);
		t3.initKammer();
