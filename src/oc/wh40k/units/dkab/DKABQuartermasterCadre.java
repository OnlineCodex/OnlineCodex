...
public class DKABQuartermasterCadre extends Eintrag {
	...
	public DKABQuartermasterCadre() {
		...
		rkTransport = new RuestkammerStarter(ID, randAbstand, cnt, "DKABCentaur", "Centaur");
