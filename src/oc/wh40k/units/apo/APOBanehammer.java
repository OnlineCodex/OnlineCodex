...
public class APOBanehammer extends Eintrag {
	...
	public APOBanehammer() {
        ...
        ogE.addElement(new OptionsGruppeEintrag("sync. schwerer Bolter", "Laserkanone + synchronisierter schwerer Bolter", 0));
		ogE.addElement(new OptionsGruppeEintrag("sync. schwerer Flamer", "Laserkanone + synchronisierter schwerer Flammenwerfer", 0));
