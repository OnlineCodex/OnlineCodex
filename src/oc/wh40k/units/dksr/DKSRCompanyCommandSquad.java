...
public class DKSRCompanyCommandSquad extends Eintrag {
	...
	public DKSRCompanyCommandSquad() {
		...
		add(oe5 = new OptionsEinzelZaehler(0, randAbstand, cnt, "", "Master of Ordnance", 1, 20));
		add(oe6 = new OptionsEinzelZaehler(0, randAbstand, cnt, "", "Officer of the Fleet", 1, 20));

		seperator();

		rkTransport = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRCentaur", "Centaur");
	...
	public void refreshen() {
        ...
        rkTransport.setAktiv(!(oe5.isSelected() || oe6.isSelected()));
	}
