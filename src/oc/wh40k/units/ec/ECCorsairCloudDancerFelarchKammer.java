...
public class ECCorsairCloudDancerFelarchKammer extends RuestkammerVater {
	...
	public ECCorsairCloudDancerFelarchKammer() {
		grundkosten = 10;
	}
	...
	public void initButtons(boolean... defaults) {
		...
		ogE.addElement(new OptionsGruppeEintrag("Brace of pistols", 0));
		...
		ogE.addElement(new OptionsGruppeEintrag("Dissonance pistol", 15));
