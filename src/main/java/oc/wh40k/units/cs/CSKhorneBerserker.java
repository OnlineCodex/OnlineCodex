...
public class CSKhorneBerserker extends Eintrag {
    ...
    public CSKhorneBerserker() {
        ...
        champion = new RuestkammerStarter(ID, randAbstand, cnt, "CSChampion", "Berserkerchampion", 1);
        ...
        addToInformationVector("CSBerserker", 1);
    ...
    public void deleteYourself() {
        addToInformationVector("CSBerserker", -1);
        if (getCountFromInformationVector("CSDreadBerserker") < 1 && getCountFromInformationVector("CSBerserker") < 1) {
