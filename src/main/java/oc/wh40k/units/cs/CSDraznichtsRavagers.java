...
public class CSDraznichtsRavagers extends Eintrag {
	...
	public CSDraznichtsRavagers() {
		...
		champion = new RuestkammerStarter(ID, randAbstand, cnt, "CSChampion", "Draznicht");
	...
	public void deleteYourself() {
		if ( spezialAuswahl){
			addToInformationVector("CSDraznichtsRavagers", -1);
		}
	...
	public void refreshen() {
		...
		if(getCountFromInformationVector("CSDraznichtsRavagers") > maxEliteKrieger && kategorie == 3) {
			setFehlermeldung("Max. " + maxEliteKrieger + " Draznichts Ravagers");
		} else {
			setFehlermeldung("");
		}
	}
