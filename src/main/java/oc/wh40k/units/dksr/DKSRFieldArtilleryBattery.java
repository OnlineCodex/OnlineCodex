...
public class DKSRFieldArtilleryBattery extends Eintrag {
    ...
    public DKSRFieldArtilleryBattery() {
        ...
        t1 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRFieldArtillery", "");
        t1.initKammer();
        t1.setButtonText("Field Artillery");
        add(t1);

        tr1 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRCentaur", "Centaur");
        tr1.initKammer();
        add(tr1);

        seperator();

        t2 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRFieldArtillery", "");
        t2.initKammer();
        t2.setButtonText("Field Artillery");
        add(t2);

        tr2 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRCentaur", "Centaur");
        tr2.initKammer();
        add(tr2);

        seperator();

        t3 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRFieldArtillery", "");
        t3.initKammer();
        t3.setButtonText("Field Artillery");
        add(t3);

        tr3 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRCentaur", "Centaur");
        tr3.initKammer();
        add(tr3);

        seperator();

        t4 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRFieldArtillery", "");
        t4.initKammer();
        t4.setButtonText("Field Artillery");
        add(t4);

        tr4 = new RuestkammerStarter(ID, randAbstand, cnt, "DKSRCentaur", "Centaur");
        tr4.initKammer();
        add(tr4);
