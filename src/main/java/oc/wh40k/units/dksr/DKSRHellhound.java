...
public class DKSRHellhound extends RuestkammerVater {
    ...
    public void initButtons(boolean... defaults) {
        ...
        ogE.addElement(new OptionsGruppeEintrag("Hellhound", 125));
        ogE.addElement(new OptionsGruppeEintrag("Devil dog", 135));
        ...
        add(oe1 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "option", "Heavy stubber", 5));
        add(oe2 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "option", "Storm bolter", 5));
