...
public class APOStormsword extends Eintrag {
    ...
    public APOStormsword() {
        ...
        add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Befehlspanzer", 200));
        ...
        ogE.addElement(new OptionsGruppeEintrag("LK + sync. schwerer Bolter", "Laserkanone + synchronisierter schwerer Bolter", 0));
        ogE.addElement(new OptionsGruppeEintrag("LK + sync. schwerer Flamer", "Laserkanone + synchronisierter schwerer Flammenwerfer", 0));
