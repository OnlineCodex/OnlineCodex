...
public class IMDeathwatchReiverSquad extends Eintrag {
    ...
    public IMDeathwatchReiverSquad() {
        ...
        ogE.addElement(new OptionsGruppeEintrag("Bolt carbine & Bolt pistol", getPts("Bolt carbine") + getPts("Bolt pistol (DW)")));
    ...
    public void refreshen() {
        o1.setPreis(0, (squad.getModelle() - 1) * (getPts("Bolt carbine (DW)")));
