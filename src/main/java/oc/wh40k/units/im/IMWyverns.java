...
public class IMWyverns extends Eintrag {
    ...
    public IMWyverns() {
        name = "Wyverns";
        grundkosten = 0;
        squad = new AnzahlPanel(ID, randAbstand, cnt, "Wyvern", "Wyverns", 1, 3, getPts("Wyverns") + getPts("Wyvern quad stormshard mortar"));
        add(squad);
