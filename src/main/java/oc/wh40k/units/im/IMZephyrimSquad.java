...
public class IMZephyrimSquad extends Eintrag {

    private static AnzahlPanel squad;

    public IMZephyrimSquad() {
    	super(IMPERIUM, ADEPTUS_MINISTORUM, ADEPTA_SORORITAS, ORDER, INFANTRY, JUMP_PACK, FLY, SERAPHIM_SQUAD);
        name = "Seraphim Squad\n";
        grundkosten = 0;
        überschriftSetzen = true;

        squad = new AnzahlPanel(ID, randAbstand, cnt, "Seraphim Squad", 5, 10, getPts("Zephyrim Squad") + getPts("Power sword (AMI)"));
        add(squad);
        ...
        add(createTroopChampion(IMAdeptaSororitasRuestkammer.class, true, "Upgrade zur Prioris", "Zephyrim Superior"));
