...
public class IMLemanRussDemolishers extends Eintrag {
    ...
    public IMLemanRussDemolishers() {
        ...
        t1 = new RuestkammerStarter(ID, randAbstand, cnt, IMLemanRussDemolisher.class, "", 1);
        t1.initKammer();
        ...
        t2 = new RuestkammerStarter(ID, randAbstand, cnt, IMLemanRussDemolisher.class, "", 1);
        t2.initKammer();
        ...
        t3 = new RuestkammerStarter(ID, randAbstand, cnt, IMLemanRussDemolisher.class, "", 1);
        t3.initKammer();
