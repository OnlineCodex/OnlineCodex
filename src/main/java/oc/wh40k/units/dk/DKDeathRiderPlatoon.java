...
public class DKDeathRiderPlatoon extends Eintrag {
	...
	public DKDeathRiderPlatoon() {
		...
		commandSquad = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderCommandSquad", "Death Rider Command Squad", 1);
		commandSquad.initKammer();
		add(commandSquad);

		seperator();

        infantrySquad1 = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderSquadron", "Death Rider Squadron\n", 1);
		...
		infantrySquad2 = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderSquadron", "Death Rider Squadron", 1);
		...
		infantrySquad3 = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderSquadron", "Death Rider Squadron", 1);
		...
		infantrySquad4 = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderSquadron", "Death Rider Squadron", 1);
		...
		infantrySquad5 = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderSquadron", "Death Rider Squadron", 1);
		...
		infantrySquad6 = new RuestkammerStarter(ID, randAbstand, cnt, "DKDeathRiderSquadron", "Death Rider Squadron", 1);
