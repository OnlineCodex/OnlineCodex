...
public class ASSchaarderBussfertigen extends Eintrag {
    ...
    public ASSchaarderBussfertigen() {
        ...
        for (int i = 0; i < 4; i++) {
            laeuterer.add(new RuestkammerStarter(ID, randAbstand, cnt, "ASLaeutererKammer", "Läuterer", 1));
    ...
    public void refreshen() {
        ...
        adjustOptions(laeuterer, 3, "ASLaeutererKammer", "Läuterer", 1 + repentias.size(), 1);
