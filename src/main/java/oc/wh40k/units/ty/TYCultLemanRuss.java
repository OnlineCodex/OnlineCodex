...
public class TYCultLemanRuss extends Eintrag {
    ...
    public TYCultLemanRuss() {
        ...
        ogE.addElement(new OptionsGruppeEintrag("Lascannon", getPts("Lascannon (other)")));
        add(o2 = new OptionsUpgradeGruppe(ID, randAbstand, cnt, "", ogE));
        o2.setSelected(0, true);

        seperator();

        ogE.addElement(new OptionsGruppeEintrag("2 Heavy bolters", getPts("Heavy bolter (other)") * 2));
