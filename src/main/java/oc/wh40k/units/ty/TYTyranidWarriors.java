...
public class TYTyranidWarriors extends Eintrag {
    ...
    public TYTyranidWarriors() {
        ...
        squad = new AnzahlPanel(ID, randAbstand, cnt, "Tyranid Warriors", 3, 9, getPts("Tyranid Warriors"));
        add(squad);
        ...
        add(oe2 = new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", "Toxin sacs", getPts("Toxin sacs (Tyranid Warrior)")));
    ...
    public void refreshen() {
        ...
        oe2.setPreis(squad.getModelle() * getPts("Toxin sacs (Tyranid Warrior)"));
