...
public class CMAuserkorene extends Eintrag {
	...
	public void refreshen() {
		...
		int champSelection=((CMChampion)champion.getKammer()).o2.getAnzahl("Melter")+((CMChampion)champion.getKammer()).o2.getAnzahl("Plasmawerfer");
		...
		((CMChampion)champion.getKammer()).o2.setAktiv("Melter", (o7c.getAnzahl()+o7a.getAnzahl()+o7b.getAnzahl()+o7d.getAnzahl())<4);
		((CMChampion)champion.getKammer()).o2.setAktiv("Plasmawerfer", (o7c.getAnzahl()+o7a.getAnzahl()+o7b.getAnzahl()+o7d.getAnzahl())<4);
	}
}
