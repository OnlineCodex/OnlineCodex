...
public class CMChampion extends RuestkammerVater {
    ...
    public void initButtons(boolean... defaults) {
        ...
        if (isBesessen) {
            ...
            ogE.addElement(new OptionsGruppeEintrag("Infernoboltpistole", 0));
            ogE.addElement(new OptionsGruppeEintrag("Warpflammenpistole", 5));
            add(inferno = new OptionsUpgradeGruppe(ID, randAbstand, cnt, "", ogE, 1));
            inferno.setSelected(0, true);
