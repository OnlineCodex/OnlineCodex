...
public class CMSpezialausruestung extends RuestkammerVater {
	...
	public void refreshen() {
		...
		o2.setSelected("Sprungmodul", isRaptorTalon);
	}
	...
	public void switchEntry(String name, boolean aktiv) {
		...
		if(name.equals( BuildaHQ.translate("Raptor Talon (TL)"))){ 
			if(isRaptorTalon!=aktiv){
				this.isRaptorTalon = aktiv;
				entrySwitched=true;
			}
		}
		if(entrySwitched){
