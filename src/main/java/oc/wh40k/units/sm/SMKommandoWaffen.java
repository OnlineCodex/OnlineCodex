...
public class SMKommandoWaffen extends RuestkammerVater {
	...
	public void initButtons(boolean... defaults) {
		...
		add(new OptionsEinzelUpgrade(ID, randAbstand, cnt, "", BuildaHQ.translate("Sturmschild"), 10));
