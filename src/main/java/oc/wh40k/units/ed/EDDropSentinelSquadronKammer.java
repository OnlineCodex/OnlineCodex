...
public class EDDropSentinelSquadronKammer extends RuestkammerVater {
    ...
    public EDDropSentinelSquadronKammer() {
        grundkosten = 0;
    }
    ...
    public void initButtons(boolean... defaults) {
        ...
        rkTransport = new RuestkammerStarter(ID, randAbstand, cnt, "EDValkyrieST", "Valkyrie Sky Talon");
