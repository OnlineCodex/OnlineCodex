...
public class HHCATechmarineCovenant extends Eintrag {
    ...
    public HHCATechmarineCovenant() {
        ...
        seperator();
        t2 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCATechmarineKammer", "Techmarine");
        t2.initKammer();
        add(t2);

        seperator();
        t3 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCATechmarineKammer", "Techmarine");
        t3.initKammer();
        add(t3);
