...
public class HHCAConsulServoKammer extends RuestkammerVater {
	...
	public void refreshen() {
		if (isCenturion || isChampion || isChaplain || isPrimus || isSiege) {
			...
			if(o1x.isSelected() && o1y.isSelected()) { substractor = 2; }
			else if(o1x.isSelected() || o1y.isSelected()) { substractor = 1; }
			else if(!o1x.isSelected() && !o1y.isSelected()) { substractor = 0; }
			
			if(o1c.isSelected()) { klauen = 2; }
			else if(!o1c.isSelected()) { klauen = 0; }
			...
			if(o2x.isSelected() && o2y.isSelected()) { substractor = 2; }
			else if(o2x.isSelected() || o2y.isSelected()) { substractor = 1; }
			else if(!o2x.isSelected() && !o2y.isSelected()) { substractor = 0; }
			
			if(o2c.isSelected()) { klauen = 2; }
			else if(!o2c.isSelected()) { klauen = 0; }
			...
			if(o4x.isSelected() && o4y.isSelected()) { substractor = 2; }
			else if(o4x.isSelected() || o4y.isSelected()) { substractor = 1; }
			else if(!o4x.isSelected() && !o4y.isSelected()) { substractor = 0; }
			...
			if(o5x.isSelected() && o5y.isSelected()) { substractor = 2; }
			else if(o5x.isSelected() || o5y.isSelected()) { substractor = 1; }
			else if(!o5x.isSelected() && !o5y.isSelected()) { substractor = 0; }
			...
			if(o6x.isSelected()) { substractor = 1; }
			else if(!o6x.isSelected()) { substractor = 0; }
