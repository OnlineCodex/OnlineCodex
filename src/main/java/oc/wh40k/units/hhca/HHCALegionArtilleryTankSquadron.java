...
public class HHCALegionArtilleryTankSquadron extends Eintrag {
    ...
    public HHCALegionArtilleryTankSquadron() {
        ...
        seperator();
        t1 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCAArtilleryKammer", "Legion Artillery Tank");
        t1.initKammer();
        ...
        seperator();
        t2 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCAArtilleryKammer", "Legion Artillery Tank");
        t2.initKammer();
        t2.setUeberschriftTrotzNullKostenAusgeben(true);
        add(t2);

        seperator();
        t3 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCAArtilleryKammer", "Legion Artillery Tank");
        t3.initKammer();
