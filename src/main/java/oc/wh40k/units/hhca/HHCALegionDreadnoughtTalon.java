...
public class HHCALegionDreadnoughtTalon extends Eintrag {
	...
	public HHCALegionDreadnoughtTalon() {
		...
		seperator();
		t1 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCADreadnoughtKammer", "Legion Dreadnought");
		t1.initKammer();
		t1.setAbwaehlbar(false);
		add(t1);

		seperator();
		t2 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCADreadnoughtKammer", "Legion Dreadnought");
		t2.initKammer();
		add(t2);

		seperator();
		t3 = new RuestkammerStarter(ID, randAbstand, cnt, "HHCADreadnoughtKammer", "Legion Dreadnought");
		t3.initKammer();
		add(t3);
	...
	public void refreshen() {
            ...
            o1.setAktiv(!o2.isSelected() && getCountFromInformationVector("HHCARoW") == 3);
