...
public class DASergeant extends RuestkammerVater {
    ...
    public void refreshen() {
        ...
        if (isRavenSarge) {
            ...
            if ((isSturmSarge ? kettenschwert.isSelected() : bolter.isSelected()) && boltpistole.isSelected()) {
                substractor = 2;
            } else if ((isSturmSarge ? kettenschwert.isSelected() : bolter.isSelected()) || boltpistole.isSelected()) {
                substractor = 1;
            } else if (!(isSturmSarge ? kettenschwert.isSelected() : bolter.isSelected()) && !boltpistole.isSelected()) {
                substractor = 0;
            }
