...
public class DASchwarzeRitterDesRavenwing extends Eintrag {
    ...
    public DASchwarzeRitterDesRavenwing() {
        ...
        squad = new AnzahlPanel(ID, randAbstand, cnt, "Schwarze Ritter des Ravenwing", 3, 10, 42);
