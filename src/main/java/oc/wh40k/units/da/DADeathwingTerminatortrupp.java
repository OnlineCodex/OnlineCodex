...
public class DADeathwingTerminatortrupp extends Eintrag {
	...
	public DADeathwingTerminatortrupp() {
		...
		squad = new AnzahlPanel(ID, randAbstand, cnt, "Deathwing-Terminatoren", 5, 10, 44);
		add(squad);
	...
	public void refreshen() {
		...
		int kettcount=((count-o1.getAnzahl())>(count-1))?(count-1):(count-o1.getAnzahl());
