...
public class OptionsUpgradeGruppeVows extends OptionsVater {
    ...
    public OptionsUpgradeGruppeVows(int ID, int lX, int lY, String verzierung, Vector<OptionsGruppeEintrag> e) {
    ...
    public OptionsUpgradeGruppeVows(int ID, int lX, int lY, String verzierung, Vector<OptionsGruppeEintrag> e, int maxAnzahl) {
    ...
    public void clear() {
        for (int i = 0; i < myUpgrades.size(); ++i) {
            if (myUpgrades.elementAt(i).isSelected()) {
                myUpgrades.elementAt(i).switschCost(myUpgrades.elementAt(i).getName());
            }
        }
    }
	...
	public void mouseReleased(MouseEvent event) {
        ...
        if (punkteLimitGruppe) {
            if (button.isSelected()) {
                button.switschCost(button.getName());
...
//					}
	...
	public Element getSaveElement() {
        final Element root = BuildaHQ.getNewXMLElement("UpgradeGroupVows");
